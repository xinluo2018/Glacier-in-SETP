...
for (( i=0; i<${#lefts[@]}; i++)) 
  ...
  # path_out=data/water/water-jrc/tiles/tile_${bottom}_${left}.tif
  # path_out_reproj=data/water/water-jrc/tiles/tile_${bottom}_${left}_albers.tif
  ## -- 2. crop the globeland30 image to tiles
  # path_in=data/globeland30/2020/globeland30_mosaic_subs.tif
  # path_out=data/globeland30/2020/tiles/tile_${bottom}_${left}.tif
  # path_out_reproj=data/globeland30/2020/tiles/tile_${bottom}_${left}_albers.tif
  # ### -- 3. crop the srtm dem to tiles
  # path_in=data/dem-data/srtm-c/SRTMGL1_E.tif 
  # path_out=data/dem-data/srtm-c/tiles/tile_${bottom}_${left}.tif
  # path_out_reproj=data/dem-data/srtm-c/tiles/tile_${bottom}_${left}_albers.tif
  ...
  path_out=data/rgi60/tiles/tile_${bottom}_${left}.tif
  path_out_reproj=data/rgi60/tiles/tile_${bottom}_${left}_albers.tif
